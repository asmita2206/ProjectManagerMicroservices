package com.bluescript.taxinvoice.request;
...
public class TaxInvoiceRequest {
    ...
    public TaxInvoiceRequest( String taxInvoiceDate, String taxInvoiceType, String hsnOrSac, String gstTotal, String gst, String totalAmount, String miscChargesDesc, String miscCharges, String companyId, String projectContactId, String projectId, String purchaseOrderId) {
